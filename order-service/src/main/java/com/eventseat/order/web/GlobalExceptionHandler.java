...
/**
 * Returns consistent ProblemDetail responses so 4xx/5xx include useful detail.
 * This makes 409 from /api/v1/orders self-explanatory (idempotency, hold,
 * seats).
 */
...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleRse(ResponseStatusException ex) {
        ...
        pd.setType(URI.create("about:blank#order-error"));
        // Prefer explicit reason if provided in the throw site
